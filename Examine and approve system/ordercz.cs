    ...
    public partial class ordercz : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    string sql = $"update approval set _status = 1 where approval_id = '{id}'";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                label2.Text = dataGridView1.SelectedRows[0].Cells[0].Value.ToString();
                DialogResult dr = MessageBox.Show("是否确认驳回申请？", "信息提示", MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
                if (dr == DialogResult.OK)
                {
        ...
        private void ordercz_Load(object sender, EventArgs e)
        {
